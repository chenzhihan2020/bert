...
##
    ...
    if(example_index % 100==0):
        print("processing example %d" %example_index)
        print('\n')
#    if(example_index>10):
#        break
##
...
##find out whether a span contain any of answers
        for i in range(len(tok_start_position)):           
          if (tok_start_position[i] >= doc_start and
            ...
            start_position = tok_start_position[i] - doc_start + doc_offset
            end_position = tok_end_position[i] - doc_start + doc_offset
            break
##
        if out_of_span:
          start_position = 0
...
## write features to file
    ...
    json_file=os.path.join("triviaqa","test_features.json")
